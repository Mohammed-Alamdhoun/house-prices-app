[README.md](https://github.com/user-attachments/files/30136322/README.md)
...
The image bundles the API, templates, and the top-10 model. `DATABASE_URL` is injected at runtime from `.env` (never baked into the image).
